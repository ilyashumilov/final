...
#def f(request):
#    user = request.user
#    df_sales = pd.read_excel('/Users/a111/Desktop/Script.xlsx', sheet_name='Sipments')
...
#            new.save()
#            cntr = Containers(shipment=ship,us=request.user, number='', seal='', bales=0,
...
#def w(request):
#    user = request.user
#    df_sales = pd.read_excel('/Users/a111/Desktop/Script.xlsx', sheet_name='Лист3')
#    df_sales = pd.DataFrame(df_sales)
#    count = -1
#    print(df_sales)
#    for i in df_sales:
...
#def z(request):
#    user = request.user
#    df_sales = pd.read_excel('/Users/a111/Desktop/Script.xlsx',sheet_name='SO')
#    df_sales = pd.DataFrame(df_sales)
#    count = -1
#    print(df_sales)
#    for i in df_sales:
...
#    w(request)
    ...
    if now.strftime("%A") == 'Wednesday' and m.st == False:
